        ...
        content: (
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <div className="bg-indigo-50 p-6 rounded-xl border border-indigo-100 mb-8">
              <p className="text-indigo-900 font-medium text-lg mb-4">
                何もしないで放っておく、我慢するのではなく、薬も何もないのですが、痛みと安心すること、そして気がついたら全身の運動をすることです。
              </p>
              <p className="text-indigo-800">
                全身の運動をする、もしくは少し深呼吸して肩を回すだけで口が少し開きます。歯と歯が離れます。ということはTCHが是正されます。歯と歯が離れると舌が押さえつけることがしにくくなります。舌の押さえつけは歯と歯が合っていないと力が入りません。それに関しましても、自覚をしっかりしてください。
              </p>
              <p className="text-indigo-800 mt-2 font-bold">
                そして、そういうことで安心することによって治療すると、すなわち何もしないことではない「安心することで改善する」というのを目指す治療法です。
              </p>
            </div>
    
            <div className="space-y-4">
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors">
                <h4 className="font-bold text-lg text-gray-900 mb-2 flex items-center">
                  <span className="bg-indigo-100 text-indigo-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 shrink-0">1</span>
                  痛みについて考える時間を減らし、1人でぼんやりしない
                </h4>
                <p className="ml-11">
                  何かに集中している時に、痛みを感じにくいことに気がついていると思います。従ってその「何か」を自分で見つけて、その時間を長くしてください。（心理学・精神医学でも有用とされている方法：コービング）。もちろん、このためには、夢中になれるものを普段から意識的に作る努力が必要です。わざわざ、「痛いかな？、やっぱり痛いな？、今日も痛いかな？」などと、自分で痛みを感じる時間を増やさないようにしましょう。<br/>
                  糖尿病の方は、「食事療法としてカロリーの摂取を減らす努力」が必要です。同じように、口腔顔面痛・違野感のある方は、「痛みについて考える時間を減らす努力」が必要です。なぜ、痛いかどうかを考えてしまうのか、そのような考えが頭に浮かんだ時に、別の考え方ができないか探してみましょう（認知再構成法）。
                </p>
              </div>
    
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors">
                <h4 className="font-bold text-lg text-gray-900 mb-2 flex items-center">
                  <span className="bg-indigo-100 text-indigo-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 shrink-0">2</span>
                  痛みの原因や今後のことを考えて落ち込まない
                </h4>
                <p className="ml-11">
                  「この痛みには原因があるはずで、それを治せば痛みがすっかり治る」・「この痛みに効く治療法などないのではないか」・「あの治療のせいだ」などといった考えを持つことは、人間として当然のことです。しかし、この思考は、痛みをさらに悪化させ、あなたが痛みをコントロールしようとする意欲も奪ってしまいます。特に、歯科医院などで、痛いことをされたとかの悪いきっかけは、原因ではありませんので忘れて下さい。
                </p>
              </div>
    
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors">
                <h4 className="font-bold text-lg text-gray-900 mb-2 flex items-center">
                  <span className="bg-indigo-100 text-indigo-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 shrink-0">3</span>
                  積極的に、生活・趣味に打ち込む
                </h4>
                <p className="ml-11">
                  多くの方が、これまで続けてきた趣味・外出・旅行・仕事・家事などを辞めたりします。少しでもできることは、続けましょう。このような生活のパターンが崩れると一日中痛みのことばかりを考えてしまいます。痛みをコントロールするには、積極的に活動することも必要なのです（うつ病の場合は、除きます）。できれば、日光にあたってください。痛いから、何もできないと「全か無か」で判断しないでください。
                </p>
              </div>
    
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors">
                <h4 className="font-bold text-lg text-gray-900 mb-2 flex items-center">
                  <span className="bg-indigo-100 text-indigo-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 shrink-0">4</span>
                  家族に依存しすぎない・薬に頼らない
                </h4>
                <p className="ml-11">
                  <span className="text-sm text-gray-500 mb-1 block">（海外では薬も流行っていますが、当科では使いません）</span>
                  痛みを家族に訴えれば訴えるほど、家族は、安心して「気のせい」と思い、痛みを共感してくれなくなります。痛みがあることで何か得をしたり嫌なことをしなくて済むようになると（疾病利得）、本人が治りたいと思っているのに、無意識に治りたくないと考えてしまい、予後が悪化します。
                </p>
              </div>
    
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors">
                <h4 className="font-bold text-lg text-gray-900 mb-2 flex items-center">
                  <span className="bg-indigo-100 text-indigo-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 shrink-0">5</span>
                  筋肉・心をリラックスさせる（全身の運動が局所にも効果があります）
                </h4>
                <p className="ml-11">
                  心が緊張したり、癖を行ったり、身体に力を入れすぎたり、筋肉が硬くなると痛みが悪化するため、軽い体操や温湿布などを行って、リラックスした状態を保ってください。特に、呼吸が大切で、腹式呼吸が良いとされています（これらの方法として、マインドフルネス・瞑想・坐禅・ヨガがあります）。また、一度、全身に力をいれ、息を吐きながら筋肉を緩ませる感じを感じてください。顔の力を、だらっと抜ける感覚をしっかりと意識してください（漸進的筋弛緩法・ジェイコブソン先生）。口腔のマッサージや、顔・舌の運動も効果があります。上下の歯と歯を離すことも有用です（歯牙接触癖の改善）。
                </p>
              </div>
    
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors">
                <h4 className="font-bold text-lg text-gray-900 mb-2 flex items-center">
                  <span className="bg-indigo-100 text-indigo-800 w-8 h-8 rounded-full flex items-center justify-center mr-3 shrink-0">6</span>
                  張り紙でゆっくりと深呼吸を繰り返す
                </h4>
                <p className="ml-11">
                  癖によって痛みなどの症状が増強している方は、貼り紙をして、見た時に、その癖を行わないようにしたり、上記にあるような筋肉をゆるめたり、ゆっくりと深呼吸しながら息を吐くなど違う行動（よい癖）を行うことを数カ月努力して続けてください。そして、変容行動の強化を行います（徐々に、癖が無くなってくるのを自覚する）。このような通常では疼痛をもたらさない微小刺激が、すべて疼痛としてとても痛く認識される感覚異常のことをアロディニア（allodynia）と言います。コントロールして治しましょう。
                </p>
              </div>
            </div>
    
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-6 rounded-xl shadow-md mt-8">
              <ul className="space-y-3 font-medium text-lg">
                <li className="flex items-start">
                  <span className="mr-2">※</span>
                  心配なのに、「この程度で受診して、良いのかな？」と思わずに、気軽に予約して下さい！
                </li>
                <li className="flex items-start">
                  <span className="mr-2">※</span>
                  気にしないことを気にしたり、気にした後に落ち込まないでください。
                </li>
                <li className="flex items-start">
                  <span className="mr-2">※</span>
                  「一生、付き合っていかなくてはならない・我慢する・あきらめる」ことでは、ありません。
                </li>
              </ul>
              <div className="mt-6 pt-6 border-t border-white/20">
                <p className="font-bold text-xl leading-relaxed">
                  この痛みのコントロールは、痛み・違野感の増強要因を理解し、これ以上悪くならい・癌ではないと、「安心」することと、気になったら深呼吸・運動を行うことで、緊張をほぐすことで、症状緩和を目指す治療です。
                </p>
              </div>
            </div>

            {/* 新規追加部分：痛みを軽減するためのコントロール（表形式） */}
            <div className="mt-16 pt-10 border-t-2 border-indigo-100">
